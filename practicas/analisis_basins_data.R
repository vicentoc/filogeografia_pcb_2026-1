...
# Read csv
setwd("C:\\Users\\vicen\\OneDrive\\Escritorio\\filogeografia_pcb_r")
...
sequences_coi <- readAAStringSet("C:\\Users\\vicen\\OneDrive\\Escritorio\\filogeografia_pcb_r\\secs_coi_gb.fasta")
sequences_coi
...
write.nexus.data(
  ...
  file = "haplotypes.nex", # Nombre del archivo de salida
  format = "dna",          # Indicar que las secuencias son de ADN
  interleaved = FALSE      # Secuencias completas (no intercaladas)
)
...
file_conn <- file("hap_lineage_matrix.nex", "w")
